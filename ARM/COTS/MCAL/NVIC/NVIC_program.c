...
u8 NVIC_EnableIRQ(u8 Copy_IRQn)
{
...
u8 NVIC_DisableIRQ(u8 Copy_IRQn)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_SetPendingIRQ(u8 Copy_IRQn)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_ClearPendingIRQ(u8 Copy_IRQn)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_GetPendingIRQ(u8 Copy_IRQn, u8 *Copy_ReturnPendingFlag)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_xSetPriority(u8 Copy_IRQn, u8 Copy_Priority)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_vSetPriority(u8 Copy_IRQn, u8 Copy_GroupPriority, u8 Copy_SubPriority)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 NVIC_xGetPriority(u8 Copy_IRQn, u8 *Copy_Priority)
{
    u8 Local_FunctionStatus = E_NOT_OK;
