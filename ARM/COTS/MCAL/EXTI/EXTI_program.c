...
u8 MCAL_EXTI_InitEXTIForGPIO(u8 GPIO_Pin, u8 GPIO_Port) 
{
    ...
    u8 Local_Result = MCAL_AFIO_SetEXTIConfiguration(GPIO_Pin, PortMap);
...
u8 MCAL_EXTI_EnableLine(u8 Copy_Line)
{
...
u8 MCAL_EXTI_DisableLine(u8 Copy_Line)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 MCAL_EXTI_SetTrigger(u8 Copy_Line, u8 Copy_Mode)
{
    u8 Local_FunctionStatus = E_NOT_OK;
...
u8 MCAL_EXTI_SetCallback(u8 Copy_Line , EXTI_CallbackFunc_t CallbackFunc)
{
    u8 Local_FunctionStatus = E_NOT_OK;
